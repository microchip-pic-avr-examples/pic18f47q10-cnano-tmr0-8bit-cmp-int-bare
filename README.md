...
2. Open the *pic18f47q10-cnano-tmr0-8bit-cmp-int-bare.X* project in MPLAB® X IDE.

3. Set *pic18f47q10-cnano-tmr0-8bit-cmp-int-bare* project as main project. Right click on the project in the *Projects* tab and click *Set as Main Project*:
